...
import pandas as pd
from sharadar.loaders.ingest_sharadar import process_data_table, get_data
...
data = get_data(sharadar_metadata_df, related_tickers, start=0, end=None)
...
#unknown_sids = data[data['sid'] == -1]
#data.drop(unknown_sids.index, inplace=True)
