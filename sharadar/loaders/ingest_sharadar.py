...
def _ingest(start, calendar=get_calendar('XNYS'), output_dir=get_data_dir(),
    ...
    end_session = pd.to_datetime(last_available_date(), utc=False)
    ...
    log.info('zipline: sharadar ingest finished')

def from_nasdaqdatalink():
    """
    ticker,date,open,high,low,close,volume,lastupdated
    A,2008-01-02,36.67,36.8,36.12,36.3,1858900.0,,2017-11-01
