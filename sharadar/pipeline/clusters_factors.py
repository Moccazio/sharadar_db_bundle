...
pipe_columns = columns = {
    'returns_21d': Returns(window_length=21),
    # Accruals
    'accruals_cowc_gr1a': cowc_gr1a,
    'Accruals_oaccruals_ni': oaccruals_ni,
    # Debt Issuance
    'debt_issuance_noa_at': noa_at,
    'debt_issuance_nfna_gr1a': nfna_gr1a,
    # Investment
    'investment_noa_gr1a': noa_gr1a,
    'investment_nncoa_gr1a': nncoa_gr1a,
    # Leverage
    'leverage_aliq_mat': aliq_mat,
    'leverage_at_be': at_be,
    # Low Risk
    'Low_Risk_fcf_me': fcf_me,
    'Low_Risk_rmax5_21d': rmax5_21d,
    # Momentum
    'Momentum_res_var': res_var,
    'Momentum_ret_12_1': ret_12_1,
    # Profit Growth
    'Profit_Growth_dsale_dinv': dsale_dinv,
    'Profit_Growth_ocf_at_chg1': ocf_at_chg1,
    # Profitability
    'Profitability_ocf_at': ocf_at,
    'Profitability_niq_be': niq_be,
    # Quality
    'Quality_cop_at': cop_at,
    'Quality_cop_atl1': cop_atl1,
    # Size
    'Size_rd_me': rd_me,
    'Size_dolvol_126d': dolvol_126d,
    # Skewness
    'Skewness_rmax5_rvol_21d': rmax5_rvol_21d,
    'Skewness_rskew_21d': rskew_21d,
    # Value
    'Value_eqnpo_me': eqnpo_me,
    'Value_ocf_me': ocf_me,
    # arbitage_pricing
#    'pmi_beta':pmi_beta,
#    'infr_beta':infr_beta,
